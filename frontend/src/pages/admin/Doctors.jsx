...
const doctors = [
  { name: 'Emma Johnson', specialty: 'Gynaecology', email: 'johndoe@gmail.com', phone: '254 1234 123 1234', schedule: 'Mon, Wed, Fri', status: 'Schedule' },
  { name: 'Sophia Miller', specialty: 'Gynaecology', email: 'johndoe@gmail.com', phone: '254 1234 123 1234', schedule: 'Mon, Wed, Fri', status: 'Schedule' },
  { name: 'Olivia Davis', specialty: 'Gynaecology', email: 'johndoe@gmail.com', phone: '254 1234 123 1234', schedule: 'Mon, Wed, Fri', status: 'Schedule' },
  { name: 'Olivia Davis', specialty: 'Gynaecology', email: 'johndoe@gmail.com', phone: '254 1234 123 1234', schedule: 'Mon, Wed, Fri', status: 'Schedule' },
  { name: 'Sophia Miller', specialty: 'Gynaecology', email: 'johndoe@gmail.com', phone: '254 1234 123 1234', schedule: 'Mon, Wed, Fri', status: 'Checked In' },
  { name: 'Emma Johnson', specialty: 'Gynaecology', email: 'johndoe@gmail.com', phone: '254 1234 123 1234', schedule: 'Mon, Wed, Fri', status: 'Schedule' },
  { name: 'Olivia Davis', specialty: 'Gynaecology', email: 'johndoe@gmail.com', phone: '254 1234 123 1234', schedule: 'Mon, Wed, Fri', status: 'Schedule' },
  { name: 'Olivia Davis', specialty: 'Gynaecology', email: 'johndoe@gmail.com', phone: '254 1234 123 1234', schedule: 'Mon, Wed, Fri', status: 'Schedule' },
];
    ...
    <div className="bg-white rounded-xl shadow p-6 border border-gray-100">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4">
        ...
        <div className="flex items-center gap-2">
          <button className="px-5 py-2 rounded-lg bg-pink-400 text-white font-semibold text-sm hover:bg-pink-500">Add Doctors</button>
          ...
          <tbody>
            {doctors.map((d, i) => (
              <tr key={i} className="border-b last:border-b-0">
                ...
                <td className="px-4 py-2 whitespace-nowrap">{d.specialty}</td>
                <td className="px-4 py-2 whitespace-nowrap">{d.email}</td>
                <td className="px-4 py-2 whitespace-nowrap">{d.phone}</td>
                <td className="px-4 py-2 whitespace-nowrap">{d.schedule}</td>
                <td className="px-4 py-2 whitespace-nowrap">
                  <span className={`px-3 py-1 rounded-full text-xs font-semibold ${statusColors[d.status]}`}>{d.status}</span>
                </td>
